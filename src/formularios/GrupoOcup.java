 ...
 * @author Danie
 */
public class GrupoOcup extends javax.swing.JFrame {
    ...
    private void CargarTabla()
    {
        ...
        String consulta = "select * from grupoocup";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrupoOcup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
